...
function document(data) {
    ...
    var state = Object.keys(data).length === 1 ? widgetState([], "right") : widgetState(data.widgets, data.widgetSide)
    return { pins: normalize(data.pins), widgets: state.widgets, widgetSide: state.widgetSide }
}
