...
assert_contains ui/dock/DockSurface.qml 'HoverHandler { id: surfaceHover }'
...
assert_contains ui/dock/DockIcon.qml 'sourceSize.width: Math.ceil(root.iconSize * 1.55 * Screen.devicePixelRatio)'
